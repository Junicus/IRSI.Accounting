...
{
  public class CGBSalesLineParser : ISalesLineParser
  {
	private readonly ISalesImportConfiguration _configurationService;
	private readonly IStoresRepository _storesRepository;
	private Store _currentStore;

	public CGBSalesLineParser(ISalesImportConfiguration configurationService, IStoresRepository storesRepository)
	{
	...
	public IEnumerable<SalesItemData> ParseLine(string line)
	{
	  ...
	  results.Add(GetItemData(line, "St Judes Sales"));
	  ...
	  var configOverShort = _configurationService.GetConfiguration("100", "Over/Short");
	...
	private SalesItemData GetItemData(string line, string accountName)
	{
	  ...
	  var accountConfig = _configurationService.GetConfiguration("100", accountName);

...
namespace IRSI.Accounting.Modules.Sales.Services
{
  ...
  public class OTBSalesLineParser : ISalesLineParser
  {
	private readonly ISalesImportConfiguration _configurationService;
	private readonly IStoresRepository _storesRepository;
	private Store _currentStore;

	public OTBSalesLineParser(ISalesImportConfiguration configurationService, IStoresRepository storesRepository)
	{
	...
	public IEnumerable<SalesItemData> ParseLine(string line)
	{
	  ...
	  var configOverShort = _configurationService.GetConfiguration("300", "Over/Short");
	...
	private SalesItemData GetItemData(string line, string accountName)
	{
	  ...
	  var accountConfig = _configurationService.GetConfiguration("300", accountName);

...
{
  public class PFCSalesLineParser : ISalesLineParser
  {
	private readonly ISalesImportConfiguration _configurationService;
	private readonly IStoresRepository _storesRepository;
	private Store _currentStore;

	public PFCSalesLineParser(ISalesImportConfiguration configurationService, IStoresRepository storesRepository)
	{
	...
	public IEnumerable<SalesItemData> ParseLine(string line)
	{
	  ...
	  results.Add(GetItemData(line, "Special Activities"));
	  ...
	  results.Add(GetItemData(line, "Special App Promo"));
	  ...
	  var configOverShort = _configurationService.GetConfiguration("400", "Over/Short");
	...
	{
	  var parts = line.Split('\t');
	  var accountConfig = _configurationService.GetConfiguration("400", accountName);
